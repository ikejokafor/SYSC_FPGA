...
HD_PWD='/home/mdl/izo5011/IkennaWorkSpace/SYSC_FPGA/ip/managed_ip_project/managed_ip_project.runs/ddr4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr4.tcl
