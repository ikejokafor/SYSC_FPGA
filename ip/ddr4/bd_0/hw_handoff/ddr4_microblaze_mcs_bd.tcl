...
################################################################
# This is a generated script based on design: bd_c703
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xcku115-flva1517-3-e
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name bd_c703
