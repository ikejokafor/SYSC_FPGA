...
#
# Generated by export_simulation on Thu Oct 14 18:13:27 EDT 2021
#
################################################################################
...
'-reset_run' switch to the './ddr4.sh' script.
...
./ddr4.sh -noclean_files

For more information on the script, please type './ddr4.sh -help'.
