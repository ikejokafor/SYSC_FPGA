...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.ddr4 \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ddr4_ex.srcs/sources_1/ip/ddr4/ip_1/rtl/map" \
       +incdir+"$ref_dir/../../../../ddr4_ex.srcs/sources_1/ip/ddr4/rtl/ip_top" \
       +incdir+"$ref_dir/../../../../ddr4_ex.srcs/sources_1/ip/ddr4/rtl/cal" \
       +incdir+"../../../../ddr4_ex.srcs/sources_1/ip/ddr4/rtl/ip_top" \
       +incdir+"../../../../ddr4_ex.srcs/sources_1/ip/ddr4/rtl/cal" \
       +incdir+"../../../../ddr4_ex.srcs/sources_1/ip/ddr4/ip_1/rtl/map"
}
