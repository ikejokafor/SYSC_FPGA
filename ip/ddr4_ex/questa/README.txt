...
#
# Generated by export_simulation on Tue Oct 19 17:18:53 EDT 2021
#
################################################################################
...
'-reset_run' switch to the './sim_tb_top.sh' script.

./sim_tb_top.sh -reset_run
...
./sim_tb_top.sh -noclean_files

For more information on the script, please type './sim_tb_top.sh -help'.
