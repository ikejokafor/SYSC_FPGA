...
#
# Generated by Vivado on Tue Sep 28 16:18:13 EDT 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v11_0_0 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_15 -L blk_mem_gen_v8_4_2 -L iomodule_v3_1_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr4 xil_defaultlib.ddr4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr4 -key {Behavioral:sim_1:Functional:ddr4} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c703.protoinst" -protoinst "protoinst_files/bd_9054.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/software/vivado-2018.3/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr4.wdb xsim.dir)
